...
if ($('.btn-success').text()) {
  ...
  // console.log(Utilities.formatDate(birthdate, `JST`, `yyyy-MM-dd HH:mm:ss`));
  ...
  // console.log(Utilities.formatDate(start, `JST`, `yyyy-MM-dd HH:mm:ss`));
  ...
  // console.log(Utilities.formatDate(end, `JST`, `yyyy-MM-dd HH:mm:ss`));
